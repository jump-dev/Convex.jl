...
function SparseAffineOperation(A, b::AbstractSparseVector)
    return SparseAffineOperation(sparse(A), b)
end
function SparseAffineOperation(A::AbstractSparseMatrix, b)
    return SparseAffineOperation(A, sparse(b))
end
...
function SparseAffineOperation(A::SparseMatrixCSC, b::SparseVector)
    ...
    return SparseAffineOperation(mat)
end

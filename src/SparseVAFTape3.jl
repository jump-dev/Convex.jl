...
function AffineOperation(op::SparseAffineOperation3)
    return AffineOperation(op.matrix, op.vector)
end
function AffineOperation(op::SparseVAFTape3)
    return AffineOperation(SparseAffineOperation3(op))
end
...
function compose(A::SparseAffineOperation3, B::SparseAffineOperation3)
    ...
    return SparseAffineOperation3(mat, vec)
end
...
function add_operation(
    tape::SparseVAFTape3{T},
    op::SparseAffineOperation3,
) where {T}
...
function operate(::typeof(-), ::Type{T}, tape::SparseVAFTape3) where {T<:Real}
...
function operate(
    ...
    return add_operation(
        tape,
        SparseAffineOperation3((T(x) * I)(d), zeros(T, d)),
    )
end
...
function operate(
    ::typeof(vcat),
    ::Type{T},
    tape1::SparseVAFTape3,
    tape2::SparseVAFTape3,
) where {T<:Real}
...
function operate(
    ::typeof(vcat),
    ::Type{T},
    arg1::SparseVAFTape3OrVec,
    arg2::SparseVAFTape3OrVec,
    arg3::SparseVAFTape3OrVec,
    args::Vararg{<:SparseVAFTape3OrVec},
) where {T<:Real}
    all_args = (arg1, arg2, arg3, args...)
    return foldl((a, b) -> operate(vcat, T, a, b), all_args)::SparseVAFTape3{T}
end

...
@add_problem constant function constant_Issue_166(
    handle_problem!,
    ::Val{test},
    atol,
    rtol,
...
@add_problem constant function constant_Issue_228(
    handle_problem!,
    ::Val{test},
    atol,
    rtol,
...
@add_problem constant function constant_Test_double_fix!(
    handle_problem!,
    ::Val{test},
    atol,
    rtol,
...
@add_problem constant function constant_fix!_and_multiply(
    handle_problem!,
    ::Val{test},
    atol,
    rtol,
...
@add_problem constant function constant_fix!_with_complex_numbers(
    handle_problem!,
    ::Val{test},
    atol,
    rtol,
...
@add_problem constant function constant_fix!_with_vectors(
    handle_problem!,
    ::Val{test},
    atol,
    rtol,

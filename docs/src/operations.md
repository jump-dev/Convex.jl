...
| `opnorm(x, 1)`                                   | maximum absolute column sum: $\max_{1 ≤ j ≤ n} \sum_{i=1}^m | x_{ij} |$                                                          | convex                              | increasing on $x \ge 0$ decreasing on $x \le 0$                       |                                                                                                                        |
| `opnorm(x, Inf)`                                 | maximum absolute row sum: $\max_{1 ≤ i ≤ m} \sum _{j=1}^n | x_{ij} |$                                                          | convex                              | increasing on $x \ge 0$ decreasing on $x \le 0$                       |                                                                                                                        |

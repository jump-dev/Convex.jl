...
### Added
 ...
 - Added support for `Base.log1p` (#718)

### Fixed

 - Fixed `DCPViolationError` for `MultiplyAtom` (#712)
 - Check constraint and objective is DCP when adding (#714)
 - Fixed Documentation of the Huber Function (#721)
 - Fixed Support for Sparse Matrices in `quadform()` (#726)

### Other

 - Documentation updates (#717), (#723)
